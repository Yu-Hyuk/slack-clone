import { Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, IconButton, List, ListItem, ListItemIcon, ListItemText, TextField,ListItemButton } from '@mui/material'
        ...
        <>
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    <TextField autoFocus margin='dense' label="설명" type="text" fullWidth variant='standard' onChange={handleChangeChannelDetail} autoComplete='off'  />
                </DialogContent>
                <DialogActions>
